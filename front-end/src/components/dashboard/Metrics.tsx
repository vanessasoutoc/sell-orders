...
import { DashboardSummary } from '@/modules/dashboard/dashboardService';

const metrics = (data: DashboardSummary) => [
...
export const Metrics = ({ data }: { data: DashboardSummary }) => (
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6">
    {metrics(data).map(({ label, value, icon }) => (
